...
import EventFirstRow from "./EventFirstRow";
import FairwayFunContainer from "./FairwayFunContainer";
...
const AllEventContainer: FunctionComponent = () => {
  return (
    <div className="absolute top-[69px] left-[0px] w-[948.7px] h-[531.9px] text-left text-[15.62px] text-darkslategray-600 font-poppins">
      ...
      />
      <EventFirstRow
        ellipse2311="/img/ellipse-23113@2x.png"
        golfMasters="GolfPro"
        nov13SUN="Nov 13, WED"
        zOZOCHAMPIONSHIP="Japan Seniors CHAMPIONSHIP"
        groupDivTop="276.6px"
        propWidth="185px"
      />
      <div className="absolute top-[368.7px] left-[0.8px] w-[947.9px] h-[71.1px] text-white">
        ...
        <div className="absolute top-[17.2px] left-[410.8px] w-[197px] h-[36.7px] text-[12.49px]">
      ...
      <div className="absolute top-[460.8px] left-[0px] w-[948.7px] h-[71.1px]">
        <div className="absolute top-[0px] left-[0px] w-[948.7px] h-[71.1px]">
          ...
          <div className="absolute top-[23.4px] left-[210.1px] leading-[150%] text-center">
            12:00 PM
          </div>
          <div className="absolute top-[15.6px] left-[851.9px] w-[58.6px] h-[39px] text-[10.93px] text-white">
            <div className="absolute top-[0px] left-[0px] w-[16.4px] h-[39px]">
              <div className="absolute top-[0px] left-[0px] w-[16.4px] h-[39px]">
                <div className="absolute top-[0px] left-[0px] rounded-[1.56px] bg-lightseagreen-200 w-[16.4px] h-[39px]" />
                <div className="absolute h-[88.97%] w-full top-[4.1%] right-[0%] bottom-[6.92%] left-[0%]">
          ...
          <div className="absolute top-[19.5px] left-[662px] leading-[15.62px] inline-block w-[163.2px]">
            It's a organizer's note. Keep in mind
          </div>
          <div className="absolute top-[23.4px] left-[295.8px] text-center">
            Nov 13, FRI
          </div>
          <div className="absolute top-[17.2px] left-[411.6px] w-[183px] h-[36.7px] text-[12.49px] text-gray1-900">
            <div className="absolute top-[0px] left-[0px] tracking-[-0.13px] leading-[14.05px] font-medium">
              JLPGA Classic CHAMPIONSHIP
            </div>
