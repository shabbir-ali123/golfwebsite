...
const LiveScoringLastRow: FunctionComponent = () => {
  return (
    <div className="absolute top-[813px] left-[16px] w-[1302px] h-[72px] text-left text-lg text-white font-poppins">
      <div className="absolute top-[0px] left-[0px] rounded bg-pink-200 shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] w-[1302px] h-[72px]" />
      <div className="absolute top-[23px] left-[199px] w-[95px] h-[26.9px]">
        <div className="absolute top-[3px] left-[0px] w-[19px] h-5 text-xl text-darkslategray-700">
          <div className="absolute top-[0px] left-[0px] w-[19px] h-5">
        ...
        <div className="absolute top-[1px] left-[70px] w-[25px] h-[24.1px]">
          ...
          <div className="absolute top-[2px] left-[2px] leading-[20px]">26</div>
        </div>
        <div className="absolute top-[0px] left-[33px] w-[27.9px] h-[26.9px]">
          ...
          <div className="absolute top-[3px] left-[5px] leading-[20px]">15</div>
        </div>
      </div>
      <div className="absolute top-[16px] left-[1187px] w-[87px] h-[41px] text-base text-black">
        <div className="absolute top-[0px] left-[0px] rounded-md box-border w-[87px] h-[41px] border-[1px] border-solid border-dimgray-100" />
        <div className="absolute top-[10px] left-[39px] leading-[20px]">-</div>
      </div>
      <div className="absolute top-[26px] left-[312px] w-[568px] h-[21px] text-dimgray-100">
        <div className="absolute top-[0px] left-[0px] w-48 h-5">
          <div className="absolute top-[0px] left-[0px] leading-[20px]">-</div>
          <div className="absolute top-[0px] left-[34px] leading-[20px]">-</div>
      ...
      <div className="absolute top-[7px] left-[5px] w-[177px] h-[58px] text-base">
        <div className="absolute top-[0px] left-[0px] w-[149px] h-[58px]">
          <div className="absolute top-[0px] left-[0px] rounded-10xs bg-darkslateblue-400 w-[149px] h-[58px]" />
...
export default LiveScoringLastRow;
