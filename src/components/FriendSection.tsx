...
const FriendSection: FunctionComponent = () => {
  return (
    <div className="absolute top-[367px] left-[calc(50%_-_653px)] w-[1323.2px] h-44 text-left text-13xl text-gray1-2100 font-poppins">
