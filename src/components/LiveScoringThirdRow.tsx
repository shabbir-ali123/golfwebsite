...
const LiveScoringThirdRow: FunctionComponent = () => {
  return (
    <div className="absolute top-[525px] left-[16px] w-[1302px] h-[72px] text-left text-lg text-white font-poppins">
      ...
      <div className="absolute top-[23px] left-[196px] w-[63px] h-[26.9px]">
        <div className="absolute top-[1px] left-[38px] w-[25px] h-[24.1px]">
          <div className="absolute top-[0px] left-[0px] rounded-sm bg-seagreen-100 w-[25px] h-[24.1px]" />
          <div className="absolute top-[2px] left-[4px] leading-[20px]">16</div>
        </div>
        <div className="absolute top-[0px] left-[0px] w-[27.9px] h-[26.9px]">
          <div className="absolute top-[0px] left-[0px] rounded-smi bg-blueviolet w-[27.9px] h-[26.9px]" />
          <div className="absolute top-[3px] left-[3px] leading-[20px]">25</div>
        </div>
      </div>
      <div className="absolute top-[15px] left-[1187px] w-[87px] h-[41px] text-base text-black">
      ...
      <div className="absolute top-[26px] left-[275px] w-[605px] h-[21px] text-dimgray-100">
        <div className="absolute top-[0px] left-[0px] w-[605px] h-[21px]">
          <div className="absolute top-[0px] left-[0px] w-[229px] h-5">
            ...
            <div className="absolute top-[0px] left-[219px] leading-[20px]">
              -
            </div>
          </div>
          <div className="absolute top-[1px] left-[309px] w-[191px] h-5">
            <div className="absolute top-[0px] left-[0px] leading-[20px]">
              -
            </div>
            <div className="absolute top-[0px] left-[37px] leading-[20px]">
          ...
          <div className="absolute top-[0px] left-[525px] w-20 h-[21px]">
      ...
      <div className="absolute top-[7px] left-[5px] w-[177px] h-[58px] text-base">
        <div className="absolute top-[0px] left-[0px] w-[149px] h-[58px]">
          <div className="absolute top-[0px] left-[0px] rounded-10xs bg-mediumseagreen-200 w-[149px] h-[58px]" />
